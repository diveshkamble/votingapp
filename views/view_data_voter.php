...
echo "<thead><tr> <th>Voter_ID</th> <th>First Name</th> <th>Middle Name</th> <th>Last Name</th> <th>Email ID</th> <th>Branch</th> <th>Hashed Pwd</th> <th>Mobile</th> <th>UIN</th> <th>Voted</th> <th></th> <th></th></thead></tr>";
...
echo '<td><a href="edit_data_voter.php?id=' . $row['voter_id'] . '">Edit</a></td>';
